<div>
    <x-jet-dropdown width="96">
        ...
        <x-slot name="content">
            ...
            @if (Cart::count())
                <div class="py-2 px-3">
                    <p class="text-lg text-grey-700 mt-2 mb-3"><span class="font-bold">Total: </span> USD {{Cart::subtotal()}}</p>

                    <x-button-enlace href="{{ route('shopping-cart') }} " color="cyan" class="w-full">
