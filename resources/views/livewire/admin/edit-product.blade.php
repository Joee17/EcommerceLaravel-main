    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-gray-700">
        ...
        <div class="bg-white shadow-xl rounded-lg p-6">
            ...
            <div class="mb-4">
                ...
                <x-jet-input wire:model="product.slug" disabled class="w-full bg-gray-200" type="text"
            ...
            <div class="grid grid-cols-2 gap-6 mb-4">
                ...
                <div>
                    ...
                    <x-jet-input min="1" step="0.001" class="w-full" type="number" wire:model="product.price" />
            ...
            @if ($this->subcategory)
                ...
                @if (!$this->subcategory->color && !$this->subcategory->size)
                    <div>
                        ...
                        <x-jet-input min="1" class="w-full" type="number" wire:model="product.quantity" />
