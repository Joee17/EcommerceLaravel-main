<div class="container py-12">
    ...
    <x-jet-form-section submit="save" class="mb-6">
        ...
        <x-slot name="description">
            Completar la información necesaria para poder agregar un nuevo departamento
        </x-slot>
        <x-slot name="form">
                    ...
                    <tr>
                        ...
                        <td class="py-2">
                            <div class="flex divide-x divide-gray-300 font-semibold">
                                <a wire:click="edit({{$department}})" class="pr-2 hover:text-green-600 cursor-pointer">Editar</a>
                                <a wire:click="$emit('deleteDepartment',{{ $department->id }})" class="pl-2 hover:text-red-600 cursor-pointer">Eliminar</a>
                            </div>
                        </td>
                    </tr>
                    @endforeach
