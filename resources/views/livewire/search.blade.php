<div class="flex-1 relative" x-data>
    ...
    <form action="{{ route('search') }}" autocomplete="off">
        ...
        <button class="absolute top-0 right-0 w-12 h-full bg-cyan-500 flex items-center justify-center rounded-r-md">
    ...
    <div class="absolute w-full">
        <div class="bg-white rounded-lg shadow mt-1 hidden" :class="{ 'hidden' : !$wire.open }"
            ...
            <div class="px-4 py-3 space-y-1">
                ...
                @empty
                    <p class="text-lg font-semibold leading-5">No existe ese producto</p>
                @endforelse
            </div>
        </div>
    </div>
