        ...
        <aside>
            ...
            <ul class="divide-y divide-gray-200 ">
                @foreach ($category->subcategories as $subcategory)
                    <li class="py-4 text-sm">
                        <a class="cursor-pointer hover:text-cyan-500 capitalize {{ $subcategoria == $subcategory->slug ? 'text-cyan-500 font-semibold' : '' }}"
            ...
            <ul class="divide-y divide-gray-200 ">
                @foreach ($category->brands as $brand)
                    <li class="py-4 text-sm">
                        <a class="cursor-pointer hover:text-emerald-500 capitalize {{ $marca == $brand->name ? 'text-emerald-500 font-semibold' : '' }}"
