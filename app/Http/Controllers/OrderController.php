...
class OrderController extends Controller
{
    ...
    public function pay(Order $order, Request $request) {
        ...
        $response = Http::get("https://api.mercadopago.com/v1/payments/$payment_id" . "?access_token=APP_USR-2133596512874885-031616-824bd9bbeebff03c17a0792fad19be16-1090919608");
